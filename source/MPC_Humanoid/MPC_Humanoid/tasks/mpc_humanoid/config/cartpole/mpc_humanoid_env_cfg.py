...
@configclass
class MpcHumanoidPhysicsCfg(PresetCfg):
...
@configclass
class MpcHumanoidSceneCfg(InteractiveSceneCfg):
...
@configclass
class MpcHumanoidEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the generated cart-pole environment."""

    # Scene settings
    scene: MpcHumanoidSceneCfg = MpcHumanoidSceneCfg(num_envs=4096, env_spacing=4.0)
    # Basic settings
    ...
    def __post_init__(self) -> None:
        ...
        self.sim.physics = MpcHumanoidPhysicsCfg()
